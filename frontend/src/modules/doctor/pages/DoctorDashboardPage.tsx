                ...
                <div className="rounded-2xl bg-slate-50 p-4 sm:col-span-2">
                  ...
                  {selectedAppointment.postVisitSummary?.status ===
                    ...
                    <p className="mt-2 text-xs text-amber-700">
                      AI is unavailable. Use the manual patient summary below
                      after saving notes.
                    </p>
                  )}
                </div>
                ...
                >
                  ...
                  {selectedAppointment.doctorNotes && (
                    <form
                      ...
                      className="mt-6 space-y-3 rounded-2xl border border-slate-200 bg-slate-50 p-4"
                    >
                      <h3 className="font-semibold">
                        3. Manual patient summary
                      </h3>
                      <p className="text-sm text-slate-500">
                        Use this when AI generation is unavailable. This is
                        published to the patient immediately.
                      </p>
                      <textarea
                        required
                      ...
                      <textarea
                        ...
                        onChange={(event) =>
                          setManualFollowUp(event.target.value)
                        }
                        rows={2}
                        placeholder="Follow-up instructions"
                        className="w-full rounded-xl border border-slate-200 px-3 py-2"
                      />
                      <button className="rounded-xl bg-slate-700 px-4 py-2 text-sm text-white">
